 ...
 * Application
 *
 * @ORM\Table(name="demo_application")
 * @ORM\Entity(repositoryClass="Demo\PlatformBundle\Repository\ApplicationRepository")
 */
class Application
{
    /**
     * @ORM\ManyToOne(targetEntity="Demo\PlatformBundle\Entity\Advert", inversedBy="applications")
